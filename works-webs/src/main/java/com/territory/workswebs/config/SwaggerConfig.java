package com.territory.workswebs.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.territory.workswebs.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("WORKS")
                .description("SPRINGBOOT 整合Swagger 项目实战")
                .termsOfServiceUrl("")
                .version("1.0")
                .build();
    }
